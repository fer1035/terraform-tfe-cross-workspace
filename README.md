...
| <a name="input_teams"></a> [teams](#input\_teams) | Names and permissions of the Teams for the Project to create and / or manage. | `map(any)` | <pre>{<br>  "owners": {<br>    "access": null<br>  }<br>}</pre> | no |
